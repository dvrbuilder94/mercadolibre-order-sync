...
describe("allocatePackPayments", () => {
  it("keeps separate payments on the orders that explicitly contain their payment_id", () => {
    ...
    expect(result.allocations).toEqual([
      {
        paymentId: "171960274409",
        orderId: "mug",
        grossAllocated: 9_990,
        netAllocated: 9_100,
        feesAllocated: 890,
        reason: "payment_id",
      },
      {
        paymentId: "171960366241",
        orderId: "pants",
        grossAllocated: 34_990,
        netAllocated: 31_500,
        feesAllocated: 3_490,
        reason: "payment_id",
      },
    ...
    expect(result.allocations).toEqual([
      {
        paymentId: "global",
        orderId: "a",
        grossAllocated: 10_000,
        netAllocated: 9_000,
        feesAllocated: 1_000,
        reason: "single_global_payment",
      },
      {
        paymentId: "global",
        orderId: "b",
        grossAllocated: 30_000,
        netAllocated: 27_000,
        feesAllocated: 3_000,
        reason: "single_global_payment",
      },
