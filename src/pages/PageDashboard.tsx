          ...
          {!loading && !error && data && (
            <>
              ...
              <div className="grid grid-cols-5 gap-3">
                ...
                <div className="bg-white rounded-xl border shadow-card hover:shadow-elevated transition-shadow p-4">
                  <div className="flex items-center justify-between mb-1">
                    <p className="text-xs text-slate-400">Neto conciliado</p>
                    <div className="h-7 w-7 rounded-full bg-primary/10 text-primary flex items-center justify-center">
                      <Scale className="h-3.5 w-3.5" />
                    </div>
                  </div>
                  <p className="text-xl font-bold text-slate-900 tabular-nums" title="Ventas − comisiones − devoluciones (estimado de P&L)">
                    {data.datosExactos.pct < 100 && "≈ "}{CLP(data.liquidoRecibido)}
                  </p>
                  <p className="text-xs text-slate-400 mt-1">después de comisiones y devoluciones</p>
                </div>
                <div className="bg-white rounded-xl border shadow-card hover:shadow-elevated transition-shadow p-4">
                  <div className="flex items-center justify-between mb-1">
